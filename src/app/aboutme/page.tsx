    ...
    <main className="content flex flex-col gap-y-12 items-center">
      ...
      <div className="flex flex-col gap-y-4">
        ...
        >
          ...
          (Leo + Virgo rising), but underneath there is a curious, adventurous,
          and slightly restless mind (Gemini Moon + Mars in Sagittarius). People
          see them as reliable and thoughtful, but once you know them, you
          realize they are playful, witty, and surprisingly bold.
        </div>
        <div
          className="font-stylish text-2xl"
          style={{ color: "var(--color-header)", opacity: 0.7 }}
